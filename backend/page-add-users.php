                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Felhasználó létrehozása</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Irja be a felhasználónevet" required id="username">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Jelszó</label>
                                        <input type="password" class="form-control" placeholder="Irja be a jelszavat" required id="password">
                                        <div class="help-block with-errors" style="color:red;" id="password_error"></div>
                                    </div>
                                </div>                              
                            </div>                            
                            <button type="button" class="btn btn-success mr-2" onclick="validateCreateUserForm()">Létrehozás</button>
