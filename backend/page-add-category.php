                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Termék kategória létrehozása</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="page-list-users.html">
                            <div class="row"> 
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>Név</label>
                                        <input type="text" class="form-control" placeholder="Irja be a kategória nevet" required id="name" >
                            ...
                            <br><br>                    
                            <button type="button" class="btn btn-success mr-2" onclick="validateCreateCategory()">Létrehozás</button>
