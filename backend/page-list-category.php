        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Kategóriák listája</h4>
                        <p class="mb-0">A kategóriák a termékekhez kapcsolódnak, minden egyes terméknek van saját kategóriája. </p>
                    </div>
                    <a href="page-add-category.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Létrehozás</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="table-responsive rounded mb-3">
                <table class="data-table table mb-0 tbl-server-info" id="category_list_table">
